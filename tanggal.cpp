...
int main(){
    ...
    // // Code dari pak Nizar sbg referensi
    // Tanggal tahunBaru{1,Januari,2021};
    // cout << "\n\nInformasi tahun baru" << endl;
    // cout << "tahun baru berikutnya = " << tahunBaru << endl;
    // tahunBaru.setTahun(2022);
    // cout <<"tahun berikutnya = " << tahunBaru << endl;
